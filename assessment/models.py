...
class Quiz(models.Model):
    ...
    enrollment = models.CharField(max_length=31, choices=[("Regular", "Regular"), ("Online", "Online")])
    createdAt = models.DateTimeField(auto_now_add=True, verbose_name="Quiz Creation TimeStamp", blank=True)
    lastUpdate = models.DateTimeField(auto_now=True, verbose_name="Last Update", blank=True)
    active = models.BooleanField(default=False)
...
class AllAssessment(models.Model):
    ...
    courseId = models.ForeignKey(Course, on_delete=models.PROTECT, verbose_name="Course Id")
    assignmentOnePoint = models.PositiveIntegerField(null=True, blank=True, verbose_name="Assignment 1 mark")
    assignmentTwoPoint = models.PositiveIntegerField(null=True, blank=True, verbose_name="Assignment 2 mark")
    assignmentThreePoint = models.PositiveIntegerField(null=True, blank=True, verbose_name="Assignment 3 mark")
    assignmentFourPoint = models.PositiveIntegerField(null=True, blank=True, verbose_name="Assignment 4 mark")
    quizOnePoint = models.PositiveIntegerField(null=True, blank=True, verbose_name="Quiz 1 mark")
    quizTwoPoint = models.PositiveIntegerField(null=True, blank=True, verbose_name="Quiz 2 mark")
    midExamPoint = models.PositiveIntegerField(null=True, blank=True, verbose_name="Mid-exam mark")
    finalExamPoint = models.PositiveIntegerField(
        null=True, blank=True, verbose_name="Final Exam Mark")
    total = models.PositiveIntegerField(null=True, blank=True, verbose_name="Total Mark")
    gradeLetter = [
        ('A+', 'A+'), ('A', 'A'), ('A-', 'A-'), 
        ('B+', 'B+'), ('B', 'B'), ('B-', 'B-'), 
        ('C+', 'C+'), ('C', 'C'), ('C-', 'C-'),
